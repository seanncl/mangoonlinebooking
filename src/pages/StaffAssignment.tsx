  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Choose your preferred staff for each service or let us assign the best available
            </p>
          </div>
                        ...
                        >
                          ...
                          <SelectContent className="bg-background z-[100]">
                            ...
                            <div className="px-2 py-1 bg-muted/50">
                              <p className="text-xs text-muted-foreground font-medium">Or choose a specific staff</p>
                            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-800">
                    Please select a staff for all services to continue. You can choose specific staff or select "Any Available" for each service.
                  </p>
                </div>
              </div>
            </div>
      ...
      <BookingFooter
        ...
        nextLabel={allServicesAssigned ? "Continue to Time Selection" : "Select Staff to Continue"}
